...
public:
	...
	using iterator        = tbb::concurrent_hash_map<idx_key_t, index_item*>::iterator;
	using const_reference = tbb::concurrent_hash_map<idx_key_t, index_item*>::const_reference;
	table_t* table_;
};
