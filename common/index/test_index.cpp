...
void Test_Index() {
    ...
    //////////////////////////////////////////////
    dbx1000::Index *index2 = new dbx1000::Index();
    ...
    //////////////////////////////////////////////
    dbx1000::Index *index3 = new dbx1000::Index();
    profiler.Clear();
    profiler.Start();
    index3->DeSerialize();
    profiler.End();
...
//////////////////////////////////////////////
    ...
    dbx1000::Index *index4 = new dbx1000::Index();
    for (int i = 0; i < INDEX_NUM; i++) {
        dbx1000::IndexItem *indexItem = new dbx1000::IndexItem(i, i);
    ...
    delete index4;
    dbx1000::Index *index5 = new dbx1000::Index();
    profiler.Clear();
    profiler.Start();
    index5->DeSerialize2();
    profiler.End();
