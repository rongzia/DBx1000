set(ds_proto_srcs "${CMAKE_CURRENT_BINARY_DIR}/global_lock_service.pb.cc")
set(ds_proto_hdrs "${CMAKE_CURRENT_BINARY_DIR}/global_lock_service.pb.h")
set(ds_grpc_srcs  "${CMAKE_CURRENT_BINARY_DIR}/global_lock_service.grpc.pb.cc")
set(ds_grpc_hdrs  "${CMAKE_CURRENT_BINARY_DIR}/global_lock_service.grpc.pb.h")
...
set(GLOBAL_LOCK_SERVICE_FILES
        ${ds_grpc_srcs}
        ${ds_proto_srcs}
        global_lock_service/grpc/global_lock_service_helper.cpp
        global_lock_service/grpc/global_lock_service.cpp
        global_lock/global_lock.cpp)

add_library(global_lock_service SHARED ${GLOBAL_LOCK_SERVICE_FILES})
target_link_libraries(global_lock_service ${gRPC_GRPC++_REFLECTION_LIBRARY_SHARED} ${gRPC_GRPCPP_SHARED} ${Protobuf_LIBRARY_SHARED})
