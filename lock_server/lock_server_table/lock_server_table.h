...
#ifndef DBX1000_LOCK_SERVER_TABLE_H
#define DBX1000_LOCK_SERVER_TABLE_H
...
namespace dbx1000 {
    ...
    public:
        ...
        bool Lock(int instance_id, uint64_t page_id, LockMode req_mode, char *page_buf, size_t count);
...
#endif //DBX1000_LOCK_SERVER_TABLE_H
